        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.unit.list')}}">Units</a></li>
              ...
              <div class="card-body">
                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-sm-12">
                      <form  method="post" id="unit_create_form" action="{{route('admin.unit.add')}}">
                        @csrf
                          ...
                          <div class="tab-pane active" id="english" role="tabpanel">
                            <div>
                              <div class="form-group required">
                                ...
                                <input type="text" class="form-control" value="{{old('en_unit_name')?old('en_unit_name'):''}}" name="en_unit_name" id="en_unit_name"  placeholder="Unit Name in English">
                          ...
                          <div class="tab-pane" id="arabic" role="tabpanel">
                            <div>
                              <div class="form-group required">
                                ...
                                <input type="text" class="form-control" value="{{old('ar_unit_name')?old('ar_unit_name'):''}}" name="ar_unit_name" id="ar_unit_name"  placeholder="Unit Name in Arabic">
                        ...
                        <input type="hidden" id="ajax_check_unit_name_unique_url" value="{{route('admin.unit.ajax_check_unit_name_unique')}}">
                        <div>
...
@push('custom-scripts')
<script type="text/javascript" src="{{asset('js/admin/unit/create.js')}}"></script>
