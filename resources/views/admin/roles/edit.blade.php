          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Edit Group/Role</h3>
              </div>
              <div class="card-body">
                      ...
                      <form  method="post" id="admin_roles_edit_form" action="{{route('admin.roles.update',$role->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                          <div class="form-group required">
                            ...
                            <input type="text"  class="form-control" value="{{old('role_name')?old('role_name'):$role->role_name}}" name="role_name" id="role_name"  placeholder="Group/Role Name">
