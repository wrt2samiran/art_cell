...
<table  width='100%' border='0' cellspacing='0' cellpadding='0' style='margin: 0 auto 20px; border-collapse:collapse;'>
 <tr>
    <td align='center' valign='top' style='font-family: Arial; font-size: 22px; color:#3381c3; line-height: 30px; font-weight: bold; text-align: center;'>Upcoming Schedule Maintenance Report</td>
 </tr>
 <tr>
...
<table width="100%" style="border-collapse: collapse;">
 ...
 <tr>
    ...
    <td align='left' valign='top' style='font-family: Arial; font-size: 14px; color:#606060; line-height: 20px; padding: 8px; border: 1px solid #ccc;'>
        ...
        <span>{{Carbon::parse($upcoming_service_date->date)->format('d/m/Y')}}</span>
    </td>
    <td align='left' valign='top' style='font-family: Arial; font-size: 14px; color:#606060; line-height: 20px; padding: 8px; border: 1px solid #ccc;'>
