          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Edit Property Manager</h3>
              </div>
              <div class="card-body">
                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-sm-12">
                      <form  method="post" id="admin_property_manager_edit_form" action="{{route('admin.property_managers.update',$property_manager->id)}}" method="post">
                        @csrf
                        @method('PUT')
                        <div>
                          <div class="form-group required">
                            <label for="first_name">First Name <span class="error">*</span></label>
                            <input type="text" class="form-control" value="{{old('first_name')?old('first_name'):$property_manager->first_name}}" name="first_name" id="first_name"  placeholder="First Name">
                          ...
                          <div class="form-group required">
                            ...
                            <input type="text" class="form-control" value="{{old('last_name')?old('last_name'):$property_manager->last_name}}" name="last_name" id="last_name"  placeholder="Last Name">
                          ...
                          <div class="form-group required">
                            ...
                            <input type="email" class="form-control" value="{{old('email')?old('email'):$property_manager->email}}" name="email" id="email"  placeholder="Last Name">
                            @if($errors->has('email'))
                          ...
                          <div class="form-group required">
                            ...
                            <input type="text" class="form-control" value="{{old('phone')?old('phone'):$property_manager->phone}}" name="phone" id="phone"  placeholder="Phone/Contact Number">
                            @if($errors->has('phone'))
                          ...
                          <div class="form-group required">
                             <label for="parent_role">Group</label>
                              <select class="form-control " disabled style="width: 100%;">
                                ...
                                @empty
                                <option value="">No Property Manager Group Found</option>
                                @endforelse
                              </select>
                          </div>
                        </div>
...
@push('custom-scripts')
<script type="text/javascript" src="{{asset('js/admin/property_managers/edit.js')}}"></script>
@endpush
