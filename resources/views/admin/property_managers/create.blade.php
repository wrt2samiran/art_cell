          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Create Property Manager</h3>
              </div>
              <div class="card-body">
                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-sm-12">
                      <form  method="post" id="admin_property_manager_create_form" action="{{route('admin.property_managers.store')}}" method="post">
                        @csrf
                        <div>
...
@push('custom-scripts')
<script type="text/javascript" src="{{asset('js/admin/property_managers/create.js')}}"></script>
@endpush
