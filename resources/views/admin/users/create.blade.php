                      ...
                      <form  method="post" id="admin_user_create_form" action="{{route('admin.users.store')}}" method="post">
                        ...
                        <div>
                          ...
                          <div class="form-group required">
                            ...
                            <input type="text" class="form-control" value="{{old('secondary_contact_number')?old('secondary_contact_number'):''}}" name="secondary_contact_number" id="secondary_contact_number"  placeholder="{{__('user_manage_module.placeholders.secondary_contact_number')}}">
