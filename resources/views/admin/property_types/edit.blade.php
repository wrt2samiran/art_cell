          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Edit Proeprty Type</h3>
              </div>
              <div class="card-body">
                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-sm-12">
                      <form  method="post" id="admin_property_type_edit_form" action="{{route('admin.property_types.update',$property_type->id)}}" method="post" >
                        ...
                        <input type="hidden" id="ajax_check_type_name_unique_url" value="{{route('admin.property_types.ajax_check_type_name_unique',$property_type->id)}}">
                        <div>
...
@endsection 
@push('custom-scripts')
<script type="text/javascript" src="{{asset('js/admin/property_types/edit.js')}}"></script>
@endpush
