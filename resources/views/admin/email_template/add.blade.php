              ...
              <div class="card-body">
                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-sm-12">
                      <form  method="post" id="admin_email_add_form" action="{{route('admin.email.add')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div>
                          <div class="form-group required">
                            <label for="name">Template Name<span class="error">*</span></label>
                            <input type="text" class="form-control" value="{{old('template_name')?old('template_name'):''}}" name="template_name" id="template_name"  placeholder="Please Enter template name">
                          ...
                          <div class="form-group required">
                           ...
                           <textarea rows="5" class="form-control"  name="content" id="content"  placeholder="Content">
                           {{old('content')?old('content'):''}}</textarea>
...
<!-- *********Used for CK Editor ***************-->
<script type="text/javascript" src="{{asset('js/admin/email_template/create.js')}}"></script>
@endpush
