                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.user-management.role-add')}}" method="POST"  id="create_role">
                            {{ csrf_field() }}
                          <div class="row">
                              <div class="col-md-10">
                                      ...
                                      <label  class="col-sm-2 col-form-label">Role Name : <span class="error">*</span></label>
                                        <div class="col-sm-10">
                                          <input type="text" name="role_name" id="role_name" class="form-control" placeholder="Role Name" title="Role Name">
                                        </div>
                                      </div>
