                          ...
                          <div class="tab-pane active" id="english" role="tabpanel">
                            <div>
                              <div class="form-group required">
                                ...
                                <input type="text" class="form-control" value="{{old('en_status_name')?old('en_status_name'):(($status->translate('en'))?$status->translate('en')->status_name:'')}}" name="en_status_name" id="en_status_name"  placeholder="Status Name in English">
                          ...
                          <div class="tab-pane" id="arabic" role="tabpanel">
                            <div>
                              <div class="form-group required">
                                ...
                                <input type="text" class="form-control" value="{{old('ar_status_name')?old('ar_status_name'):(($status->translate('ar'))?$status->translate('ar')->status_name:'')}}" name="ar_status_name" id="ar_status_name"  placeholder="Status Name in Arabic">
