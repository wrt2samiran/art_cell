    ...
    <div class="content-wrapper" style="min-height: 1200.88px;">
        ...
        <section class="content">
            <div class="container-fluid">
              ...
              @endif
              <form  method="get" id="task_list" action="{{route('admin.task_management.calendar', $task_id)}}" method="post" enctype="multipart/form-data">
                    <div class="row">
                      <div class="call-lg-3">
                              ...
                              <div class="row justify-content-center">
                                <div class="col-md-10 col-sm-12">
                                  <form  method="post" id="admin_labour_task_add_form" action="{{route('admin.task_management.taskAdd')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                          <div>  
                                            <input type="hidden" name="service_allocation_id" id="service_allocation_id" value="{{$service_allocation_id}}"> 
                                            ...
                                            <div class="form-group required">
                                              ...
                                              <select class="form-control parent_role_select2" onchange='onServiceChange(this.value)' style="width: 100%;" name="service_id" id="service_id">
                                                  ...
                                                  @if($service_data)
                                                     <option value="{{$service_data->service->id}}" {{(old('service_id')== $service_data->service->id)? 'selected':''}}>{{@$service_data->service->service_name}}</option>
                                                  @else
