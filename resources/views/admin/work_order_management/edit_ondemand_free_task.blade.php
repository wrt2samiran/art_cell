                    ...
                    <div class="col-md-10 col-sm-12">
                      <form  method="post" id="admin_labour_task_add_form" action="{{route('admin.work-order-management.taskAssign')}}" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group required">
                                ...
                                <input class="form-control parent_role_select2" style="width: 100%;" type="text" name="task_title" id="task_title" value="{{(old('task_title'))? old('task_title'):''}}" onkeyup="checkOnDemandFree()">
