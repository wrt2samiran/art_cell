          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">{{__('property_manage_module.create_property')}}</h3>
              </div>
              <div class="card-body">
                      ...
                      <form  method="post" id="admin_property_create_form" action="{{route('admin.properties.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                          <div class="form-group required">
                            ...
                            <input type="text" class="form-control" value="{{old('property_name')?old('property_name'):''}}" name="property_name" id="property_name"  placeholder="{{__('property_manage_module.placeholders.property_name')}}">
                          ...
                          <div class="form-group required">
                            ...
                            <textarea class="form-control" name="description" id="description"  placeholder="{{__('property_manage_module.placeholders.description')}}">{!!old('description')?old('description'):''!!}</textarea>
                          ...
                          <div class="row">
                            <div class="col-md-6 form-group">
                              ...
                              <input type="number" min="1" class="form-control" value="{{old('no_of_active_units')?old('no_of_active_units'):''}}" name="no_of_active_units" id="no_of_active_units"  placeholder="{{__('property_manage_module.placeholders.no_of_active_units')}}">
                            ...
                            <div class="col-md-6 form-group">
                              ...
                              <input type="number" min="0" class="form-control" value="{{old('no_of_inactive_units')?old('no_of_inactive_units'):''}}" name="no_of_inactive_units" id="no_of_inactive_units"  placeholder="{{__('property_manage_module.placeholders.no_of_inactive_units')}}">
                          ...
                          <div class="form-group required">
                            ...
                            <textarea class="form-control" name="address" id="address"  placeholder="{{__('property_manage_module.placeholders.address')}}">{!!old('address')?old('address'):''!!}</textarea>
                          ...
                          <div class="form-group required">
                            ...
                            <input type="text" class="form-control" value="{{old('location')?old('location'):''}}" name="location" id="location"  placeholder="{{__('property_manage_module.placeholders.location')}}">
                          ...
                          <div class="form-group required">
                            ...
                            <input type="text" class="form-control" value="{{old('contact_number')?old('contact_number'):''}}" name="contact_number" id="contact_number"  placeholder="{{__('property_manage_module.placeholders.contact_number')}}">
                          ...
                          <div class="form-group required">
                            ...
                            <input type="text" class="form-control" value="{{old('contact_email')?old('contact_email'):''}}" name="contact_email" id="contact_email"  placeholder="{{__('property_manage_module.placeholders.contact_email')}}">
                         ...
                         @endif
                          <div class="form-group">
                            ...
                            <input type="number" min="1" class="form-control" value="{{old('electricity_account_number')?old('electricity_account_number'):''}}" name="electricity_account_number" id="electricity_account_number"  placeholder="{{__('property_manage_module.placeholders.electricity_account_number')}}">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" min="1" class="form-control" value="{{old('water_account_number')?old('water_account_number'):''}}" name="water_account_number" id="water_account_number"  placeholder="{{__('property_manage_module.placeholders.water_account_number')}}">
