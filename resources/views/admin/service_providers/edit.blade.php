              ...
              <div class="card-body">
                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-sm-12">
                      <form  method="post" id="admin_service_provider_edit_form" action="{{route('admin.service_providers.update',$service_provider->id)}}" method="post">
                        @csrf
                        @method('PUT')
                        <div>
                          <div class="form-group required">
                            <label for="first_name">First Name <span class="error">*</span></label>
                            <input type="text" class="form-control" value="{{old('first_name')?old('first_name'):$service_provider->first_name}}" name="first_name" id="first_name"  placeholder="First Name">
                          ...
                          <div class="form-group required">
                            ...
                            <input type="text" class="form-control" value="{{old('last_name')?old('last_name'):$service_provider->last_name}}" name="last_name" id="last_name"  placeholder="Last Name">
                          ...
                          <div class="form-group required">
                            ...
                            <input type="email" class="form-control" value="{{old('email')?old('email'):$service_provider->email}}" name="email" id="email"  placeholder="Last Name">
                            @if($errors->has('email'))
                          ...
                          <div class="form-group required">
                            ...
                            <input type="text" class="form-control" value="{{old('phone')?old('phone'):$service_provider->phone}}" name="phone" id="phone"  placeholder="Phone/Contact Number">
                            @if($errors->has('phone'))
                        ...
                        <input type="hidden" id="ajax_check_user_email_unique" value="{{route('ajax.check_user_email_unique',$service_provider->id)}}">
                        <div>
...
@push('custom-scripts')
<script type="text/javascript" src="{{asset('js/admin/service_providers/edit.js')}}"></script>
@endpush
