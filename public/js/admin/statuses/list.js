    ...
    var property_types_table=$('#statuses_table').DataTable({
        "responsive": true,
        "autoWidth": false,
        processing: true,
        serverSide: true,
        ajax: $('#statuses_data_url').val(),
        columns: [
            { data: 'id', name: 'id' },
            { data: 'status_for', name: 'status_for'},
            { data: 'status_name', name: 'status_name'},
            { data: 'color_code', name: 'color_code',orderable: false, searchable: false},
    ...
    if (willDelete) {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $.LoadingOverlay("hide");
          toastr.success('Status successfully deleted.', 'Success', {timeOut: 5000});
        },
