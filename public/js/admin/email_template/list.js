...
if (willDelete) {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $.LoadingOverlay("hide");
      toastr.success('Message successfully deleted.', 'Success', {timeOut: 2000});
    },
    error: function(jqXHR, textStatus, errorThrown) {
       ...
       if(status=='404'){
        toastr.error('Invalid URL', 'Error', {timeOut: 2000});
       }else{
         toastr.error('Internal server error.', 'Error', {timeOut: 2000});
       }
    }
 });
