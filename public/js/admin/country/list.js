    ...
    if (willDelete) {
      ...
      $.ajax({
        ...
        success: function (data) {
          $.LoadingOverlay("hide");
          toastr.success('Country successfully deleted.', 'Success', {timeOut: 5000});
        },
     ...
     country_table.ajax.reload(null, false);
...
//function to change status of gallery
 function change_status(url,activate_or_deactivate){
  swal({
  title: "Are you sure?",
  text: "You want to "+activate_or_deactivate+" the country.",
  icon: "warning",
  buttons: true,
  dangerMode: true,
  })
