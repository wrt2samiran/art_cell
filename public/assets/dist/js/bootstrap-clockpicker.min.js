!(function () {
    ...
    function s(s, r) {
        ...
        r.autoclose ||
            n('<button type="button" class="btn btn-sm btn-default btn-block clockpicker-button"><strong>Set Time</strong></button>')
    ...
    (s.DEFAULTS = { default: "", fromnow: 0, placement: "bottom", align: "left", donetext: "完成", autoclose: !1, twelvehour: !1, vibrate: !0 }),
        ...
        (s.prototype.resetClock = function (t) {
            var i = this.currentView,
                ...
                a = this;
            l && t
                ? (a.canvas.addClass("clockpicker-canvas-out"),
                  setTimeout(function () {
                      a.canvas.removeClass("clockpicker-canvas-out"), a.setHand(n, r);
                  }, t))
                : this.setHand(n, r);
        }),
        (s.prototype.setHand = function (t, e, s, o) {
            ...
            if (
                (u.twelvehour && (d = g),
                0 > r && (r = 2 * Math.PI + r),
                (r = (c = Math.round(r / p)) * p),
                u.twelvehour ? (a ? 0 === c && (c = 12) : (s && (c *= 5), 60 === c && (c = 0))) : a ? (12 === c && (c = 0), (c = k ? (0 === c ? 12 : c) : 0 === c ? 0 : c + 12)) : (s && (c *= 5), 60 === c && (c = 0)),
                ...
                this[a ? "hoursView" : "minutesView"].find(".clockpicker-tick").each(function () {
                    var t = n(this);
